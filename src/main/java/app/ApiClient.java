...
import static app.Urls.FILES_ARTIFACTS_URL;
import static app.Urls.FILES_FOLDER_URL;
import static app.Urls.FILES_ANALYSES_URL;
import static app.Urls.FILES_RUNS_URL;
...
public class ApiClient extends BaseRequests {
    ...
    public Response getFilesFromRootFolder(String... optionalParams) {
        ...
        //execute request
        return get(FILES_FOLDER_URL, queryParams);
    }
    ...
    public Response getFilesCountByFolderID(String folderID) {
        ...
        queryParams.put("folder_id", folderID);
        //execute request
        return get(FILES_COUNT_URL, queryParams);
    }
    ...
    public Response getRunsByFileID(String fileID) {
        ...
        url = String.format(FILES_RUNS_URL, fileID);
        //set up queryParams
        HashMap<String, String> queryParams = new HashMap<>();
        //execute request
    ...
    public Response getAnalysesByRunID(String runID, String... optionalParams) {
        ...
        url = String.format(FILES_ANALYSES_URL, runID);
        //set up queryParams
        HashMap<String, String> queryParams = new HashMap<>();
        // Option for optional params
        int length = optionalParams.length;
    ...
    public Response getArtifactsByRunID(String runID) {
        //set up url with specified runID
        url = String.format(FILES_ARTIFACTS_URL, runID);
        //set up queryParams
        HashMap<String, String> queryParams = new HashMap<>();
        //execute request
        return get(url, queryParams);
